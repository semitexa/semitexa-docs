---
id: runtime/sessions-and-cookies
section: runtime
slug: sessions-and-cookies
title: Sessions and Cookies
summary: The session contract and its Swoole Table storage, typed session segments, flash messages, and reading and writing cookies.
order: 20
locale: en
status: canonical
keywords:
