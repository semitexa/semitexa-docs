...
section: data
slug: orm-guide
title: ORM Working Guide
summary: Declaring a resource, querying it, relations and write policies, optimistic locking, transactions, wiring a store, and the gotchas.
order: 100
locale: en
status: canonical
keywords:
