---
id: rendering/ui-grammar
section: rendering
slug: ui-grammar
title: UI Grammar Reference
summary: The attribute grammar a component author writes: what each attribute means and where it is allowed.
order: 200
locale: en
status: canonical
keywords:
