---
id: rendering/ui-ssr-integration
section: rendering
slug: ui-ssr-integration
title: UI and SSR Integration
summary: How platform-ui primitives and components sit on top of the SSR module.
order: 210
locale: en
status: canonical
keywords:
