# Syntexa Framework Examples

> **Status:** Draft - To be completed  
> **Location:** Framework docs — `packages/syntexa/docs/guides/EXAMPLES.md`

This document provides practical examples of using Syntexa Framework.
