...
> **Location:** Framework docs — `packages/syntexa/docs/guides/CONVENTIONS.md`
...
```php
#[Documentation]  // Auto-finds docs in packages/syntexa/core/docs/attributes/
...
```php
#[Documentation(path: 'packages/syntexa/core/docs/attributes/AsRequest.md')]
#[AsRequest(path: '/api/users')]
class UserListRequest implements RequestInterface {}
```
