...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-docs/security/advisories/new).
...
In scope: anything in `semitexa/docs` that lets a request, a job or a message do
